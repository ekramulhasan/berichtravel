        ...
        <div class="row g-5">
            <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
               <div class="cart shadow p-3 mb-5 bg-white rounded">
                ...
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link active" id="v-pills-profile-tab" data-toggle="pill" href="{{ route('customer.deposit') }}" role="tab" aria-controls="v-pills-profile" aria-selected="false">Top-Up</a>
            ...
            <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.3s">
               <div class="shadow-lg p-3 mb-5 bg-white rounded" style="width: 90%; margin:0px auto">
                <div class="title text-center py-5"><h4>Deposit Balance</h4></div>
                <form method="POST" action="{{ route('submit.deposit') }}">
                    @csrf
                    <input type="hidden" name="customer_id" value="{{ Auth::guard('customer')->user()->id }}">
                    <select name="payment_method" class="form-select my-3" aria-label="Default select example">
                      ...
                      <div class="form-group my-3">
                        <label for="formGroupExampleInput my-2" style="margin-left: 5px;">Account Number</label>
                        <input type="number" name="account_number" class="form-control" id="formGroupExampleInput" placeholder="Account Number">
                      </div>

                      <div class="form-group my-3">
                        <label for="formGroupExampleInput  my-2" style="margin-left: 5px;">Amount</label>
                        <input type="number" name="amount" class="form-control" id="formGroupExampleInput" placeholder="Amount">
                      </div>

                      <div class="form-group my-3">
                        <label for="formGroupExampleInput my-3" style="margin-left: 5px;">Transaction Id</label>
                        <input type="text" name="transaction_id" class="form-control" id="formGroupExampleInput" placeholder="Transaction Id">
                      </div>
