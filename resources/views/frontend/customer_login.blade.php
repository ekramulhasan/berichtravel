                ...
                <div class="col-md-12">
                    <div class="_lk_de">
                        <div class="form-03-main">
                            ...
                            <div class="form-group nm_lk font-weight-bold">

                                <p class=""><a href="{{ route('customer.register') }}">Customer Registration</a>
                                    Or <a href="{{ route('customer.register') }}">Vendor Registration</a> </p>
