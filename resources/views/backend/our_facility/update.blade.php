    ...
    <div class="col">
        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <small class="text-muted float-end"><a href="{{ route('our-facility.index') }}" class="btn btn-primary"> <i
                            class='bx bx-left-arrow-alt'></i> Back Service List</a></small>
            </div>
            <div class="card-body">
                <form action="{{ route('our-facility.update',$service_data->id) }}" method="POST">
                    @csrf
                    @method('PUT')
