                    ...
                    <form action="{{ route('destination.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('country_name')
                                is-invalid
                            @enderror" id="country_name" placeholder="enter country name" name="country_name" >
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('off_per')
                                is-invalid
                            @enderror" id="off_per" placeholder="enter client off_per" name="off_per">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="file" class="form-control dropify" id="" name="country_img">
