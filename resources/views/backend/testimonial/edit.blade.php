        ...
        <div class="col-12 mt-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('testimonial.update', $testimonial_data->id) }}" method="post"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                is-invalid
                            @enderror"
                                id="client_name" placeholder="enter client name" name="client_name"
                                value="{{ $testimonial_data->client_name }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                is-invalid
                            @enderror"
                                id="client_designation" placeholder="enter client designation" name="client_designation"
                                value="{{ $testimonial_data->client_designation }}">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-floating">
                                ...
                                is-invalid
                                @enderror"
                                    placeholder="Client Message" id="floatingTextarea2" style="height: 150px" name="client_msg">{{ $testimonial_data->client_msg }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control dropify" id="" name="client_img"
                                data-default-file="{{ asset('uploads/testimonial') }}/{{ $testimonial_data->client_img }}">
